...
BookDTO dto=dao.searchBook(BookName1);
...
String Categary=dto.getCategary();
...
String Publisher=dto.getPublisher();
 ...
 <%-- <input type="hidden" name="BookID" value=<%=dto.getBookID()%> readonly="readonly" /> --%>				
				     <input type="hidden" name="BookID" value=<%=dto.getBookID()%> />
				     
					<label>BookName</label>
					<input type="text" name="BookName" value="<%=dto.getBookName()%> "placeholder="BookName" required/>
				
					<label>Author</label>
					<input type="text" name="Author"  value="<%=dto.getAuthor()%> "placeholder="Author" required/>
								
					<label>Publisher</label>
					<input type="text" name="Publisher"  value="<%=dto.getPublisher()%>" placeholder="Publisher" required/>
					
					<label>Quantity</label>
					<input type="text" name="Quantity" value="<%=dto.getQuantity()%>"placeholder="Quantity" required/>
					
					<label>Price</label>
					<input type="text" name="Price"  value="<%=dto.getPrice()%>"placeholder="Price" required/>
					
					<label>Categary</label>
					<input type="text" name="Categary" value="<%=dto.getCategary()%>"placeholder="Categary" required/>
