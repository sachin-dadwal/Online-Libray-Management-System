...
<body>
	...
	<%@ page import="java.io.*"%>
	<%@ page import="com.jsp.liberary.DTO.BookDTO"%>
	<%@page import="com.jsp.liberary.DAO.BookDAO"%>
<%
...
<%
	...
	<h1><mark>Available books to buy</mark></h1>
		<!-- <div class="wrapper"> -->
...
<td height=180px width=160px> <img alt=" Add Image" src="http://localhost:8080/Library_MGT_V1/images/upload/<%=Book.getBookName()%>.jpg"  width=220px height=200px></td>				
...
<td><h2><b><div align="center"><font color='yellow'><u>Categary:</div></b></h2><br><h3><b><div align="center"><font color='white'><%=Book.getCategary()%></div></b></h3></td>
				...
				<td>
						...
						<h2><b><div align="center"><i><u><mark>_ Buy Now_</mark></u></i></div></b></h2><input type="submit" value="Buy Now">
					</form>
					</td>
					</tr>
