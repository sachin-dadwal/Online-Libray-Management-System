	...
	<%@ page import="java.io.*"%>
	<%@ page import="DTO.BorrowDTO"%>


	<%!BorrowDAO dao = new BorrowDAO();%>
<div align="center">
	<%
		List<BorrowDTO> book = dao.selectAll();
	...
	<h1><a href="Home.jsp">Home</a></h1>
		...
		<table border=3>
			...
			<tr>
				...
				<td>
					<form action="IsActivateController" method="post">
 ...
 --%>
			...
			<tr>
				...
				<%--<td>BookID:
					...
					<td><h2>BorrowID:</h2><h2><%=Book.getBID()%></h2></td>
					...
					<td><h2>IsActive:</h2><h2><%=Book.getIsActive()%></h2></td>
